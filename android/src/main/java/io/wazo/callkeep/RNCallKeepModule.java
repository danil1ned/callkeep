...
public class RNCallKeepModule
  ...
  public static RNCallKeepModule getInstance(
    ...
    if (instance == null) {
      Log.d(
        TAG,
        "[RNCallKeepModule] getInstance : " +
        (reactContext == null ? "null" : "ok")
      );
  ...
  public void reportNewIncomingCall(
    ...
    Log.d(
      TAG,
      "[RNCallKeepModule] reportNewIncomingCall, uuid: " +
      uuid +
      ", number: " +
      number +
      ", callerName: " +
  ...
  public void initializeTelecomManager() {
    ...
    if (context == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule][initializeTelecomManager] no react context found."
      );
      return;
    }
      ...
      switch (state) {
        ...
        case TelephonyManager.CALL_STATE_OFFHOOK:
          ...
          boolean isInManagedCall =
            RNCallKeepModule.this.checkIsInManagedCall();
          ...
          if (RNCallKeepModule.this.hasActiveCall && isInManagedCall) {
            WritableMap args = Arguments.createMap();
            RNCallKeepModule.this.sendEventToJS(
                "RNCallKeepHasActiveCall",
                args
              );
  ...
  public void registerPhoneAccount(ReadableMap options) {
    ...
    if (context == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule][registerPhoneAccount] no react context found."
      );
      return;
    }
  ...
  public void registerEvents() {
    if (!isConnectionServiceAvailable()) {
      Log.w(
        TAG,
        "[RNCallKeepModule] registerEvents ignored due to no ConnectionService"
      );
      return;
    }
  ...
  public void displayIncomingCall(
    ...
    Log.d(
      TAG,
      "[RNCallKeepModule] displayIncomingCall, uuid: " +
      uuid +
      ", number: " +
      number +
      ", callerName: " +
  ...
  public void answerIncomingCall(String uuid) {
    ...
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] answerIncomingCall ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  public void startCall(
    ...
    Log.d(
      TAG,
      "[RNCallKeepModule] startCall called, uuid: " +
      uuid +
      ", number: " +
      number +
      ", callerName: " +
    ...
    if (
      ...
      Log.w(
        TAG,
        "[RNCallKeepModule] startCall ignored: " +
        isConnectionServiceAvailable() +
        ", " +
        hasPhoneAccount() +
        ", " +
  ...
  public void endCall(String uuid) {
    ...
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] endCall ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  public void checkPhoneAccountPermission(
    ReadableArray optionalPermissions,
    Promise promise
  ) {
    ...
    final String[] allPermissions = Arrays.copyOf(
      permissions,
  ...
  public void checkDefaultPhoneAccount(Promise promise) {
    ...
    boolean hasDefaultAccount =
      telecomManager.getDefaultOutgoingPhoneAccount("tel") != null;
  ...
  public void setOnHold(String uuid, boolean shouldHold) {
    Log.d(
      TAG,
      "[RNCallKeepModule] setOnHold, uuid: " +
      uuid +
      ", shouldHold: " +
      (shouldHold ? "true" : "false")
    );
    ...
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] setOnHold ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  public void reportEndCallWithUUID(String uuid, int reason) {
    Log.d(
      TAG,
      "[RNCallKeepModule] reportEndCallWithUUID, uuid: " +
      uuid +
      ", reason: " +
      reason
    );
    ...
    VoiceConnection conn = (VoiceConnection) VoiceConnectionService.getConnection(
      uuid
    );
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] reportEndCallWithUUID ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  public void rejectCall(String uuid) {
    ...
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] rejectCall ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  public void setConnectionState(String uuid, int state) {
    Log.d(
      TAG,
      "[RNCallKeepModule] setConnectionState, uuid: " +
      uuid +
      ", state :" +
      state
    );
  ...
  public void setMutedCall(String uuid, boolean shouldMute) {
    Log.d(
      TAG,
      "[RNCallKeepModule] setMutedCall, uuid: " +
      uuid +
      ", shouldMute: " +
      (shouldMute ? "true" : "false")
    );
    Connection conn = VoiceConnectionService.getConnection(uuid);
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] setMutedCall ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  public void toggleAudioRouteSpeaker(String uuid, boolean routeSpeaker) {
    Log.d(
      TAG,
      "[RNCallKeepModule] toggleAudioRouteSpeaker, uuid: " +
      uuid +
      ", routeSpeaker: " +
    ...
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] toggleAudioRouteSpeaker ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  public void getAudioRoutes(Promise promise) {
    try {
      ...
      if (context == null) {
        Log.w(
          TAG,
          "[RNCallKeepModule][getAudioRoutes] no react context found."
        );
      ...
      AudioDeviceInfo[] audioDeviceInfo = audioManager.getDevices(
  ...
  public void sendDTMF(String uuid, String key) {
    ...
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] sendDTMF ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  public void updateDisplay(String uuid, String displayName, String uri) {
    Log.d(
      TAG,
      "[RNCallKeepModule] updateDisplay, uuid: " +
      uuid +
      ", displayName: " +
      displayName +
      ", uri: " +
    ...
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] updateDisplay ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  @ReactMethod
  public void setForegroundServiceSettings(
    ReadableMap foregroundServerSettings
  ) {
  ...
  public void setCurrentCallActive(String uuid) {
    ...
    if (conn == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule] setCurrentCallActive ignored because no connection found, uuid: " +
        uuid
      );
      return;
    }
  ...
  public void openPhoneAccounts() {
    ...
    if (!isConnectionServiceAvailable()) {
      Log.w(
        TAG,
        "[RNCallKeepModule] openPhoneAccounts ignored due to no ConnectionService"
      );
      return;
    }
    ...
    if (
      ...
      if (context == null) {
        Log.w(
          TAG,
          "[RNCallKeepModule][openPhoneAccounts] no react context found."
        );
        return;
      }
  ...
  public void openPhoneAccountSettings() {
    ...
    if (context == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule][openPhoneAccountSettings] no react context found."
      );
      return;
    }
    context.startActivity(intent);
  ...
  public void backToForeground() {
    ...
    if (context == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule][backToForeground] no react context found."
      );
      return;
    }
  ...
  public static void onRequestPermissionsResult(
    ...
    for (int result : grantResults) {
      if (
        permsList.contains(grantedPermissions[permissionsIndex]) &&
  ...
  public void sendEventToJS(String eventName, @Nullable WritableMap params) {
    ...
    Log.v(
      TAG,
      "[RNCallKeepModule] sendEventToJS, eventName: " +
      eventName +
      ", bound: " +
      isBoundToJS +
      ", hasListeners: " +
  ...
  protected static void fetchStoredSettings(@Nullable Context fromContext) {
    if (instance == null && fromContext == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule][fetchStoredSettings] no instance nor fromContext."
      );
      return;
    }
    Context context = fromContext != null
      ? fromContext
    ...
    if (context == null) {
      Log.w(
        TAG,
        "[RNCallKeepModule][fetchStoredSettings] no react context found."
      );
      return;
    }
    ...
    try {
      String jsonString = sharedPref.getString(
        "settings",
  ...
  private class VoiceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      WritableMap args = Arguments.createMap();
      HashMap<String, String> attributeMap = (HashMap<String, String>) intent.getSerializableExtra(
        "attributeMap"
      );
      ...
      switch (intent.getAction()) {
        ...
        case ACTION_ANSWER_CALL:
          ...
          args.putBoolean(
            "withVideo",
            Boolean.valueOf(attributeMap.get(EXTRA_HAS_VIDEO))
          );
        ...
        case ACTION_WAKE_APP:
          ...
          Log.d(
            TAG,
            "[RNCallKeepModule] wakeUpApplication: " +
            attributeMap.get(EXTRA_CALL_UUID) +
            ", number : " +
            attributeMap.get(EXTRA_CALL_NUMBER) +
            ", displayName:" +
